...
const ModelLab: React.FC<ModelLabProps> = ({ data }) => {
  ...
  return (
    <div className="space-y-8 animate-fade-in pb-10">
      ...
      {featureResult && (
        <div className="bg-white rounded-2xl shadow-card border border-ink-quaternary overflow-hidden animate-fade-in-up">
            <div className="p-6 border-b border-ink-quaternary bg-surface-secondary/50 flex justify-between items-center">
                <div>
